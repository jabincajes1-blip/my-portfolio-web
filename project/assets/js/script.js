...
// ============== TYPED JS ================
const typedElement = document.querySelector(".multiple-text"); // class selector
const typed = new Typed(typedElement, {
  strings: ["Computer Literate", "Cellphone Repair Technician", "Basic Networking Knowledge"],
  typeSpeed: 100,
  backSpeed: 100,
  backDelay: 1000,
  loop: true,
